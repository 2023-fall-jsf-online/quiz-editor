...
export class AppComponent implements OnInit {
  ...
  detailsFromLeftAnimationState  = "leftPostition";
  ...
  saveQuizzes = async () => {
    try {
      ...
      const numberOfUpdatedQuizes = await this.quizSvc.saveQuizzes(
        editedQuizzes
        , newQuizzes

      );

      console.log("numberOfUpdateQuizzes", numberOfUpdatedQuizes)
    }
